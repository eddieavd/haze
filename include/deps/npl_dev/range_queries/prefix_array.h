...
//        using          const_iterator = typename _base::const_iterator;
        ...
        template< typename U = _self >
        enable_2d_range_container_base_t< U >
        old_range ( size_type _x1_, size_type _y1_, size_type _x2_, size_type _y2_ ) const
        {
        ...
        template< typename U = _self >
        enable_3d_range_container_base_t< U >
        old_range ( size_type _x1_, size_type _y1_, size_type _z1_, size_type _x2_, size_type _y2_, size_type _z2_ ) const
        {
