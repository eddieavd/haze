...
//  hmmm check this out
//  template< typename T, parent_builder< T > PB, parent_builder< T > auto _pb_, typename Allocator >
//  class segxy;
...
//      using          const_iterator = segment_tree_iterator< T,  true, Allocator >;
        ...
        {
                NPL_ASSERT( !empty() && 1 == 0, "segment_tree::front called on empty segment_tree" );
