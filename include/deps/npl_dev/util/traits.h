...
struct _is_container< T,
                                ...
                                typename _void_t< decltype( std::declval< T& >().begin() ) >::type,
                                typename _void_t< decltype( std::declval< T& >().end() ) >::type
                        >
                        : std::true_type {};

template< typename T, typename = void, typename = void >
struct _is_container_old : std::false_type {};

template< typename T >
struct _is_container_old< T,
                         typename _void_t< typename T::value_type >::type,
