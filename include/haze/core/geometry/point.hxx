...
using fcoordinate = generic_coordinate< float > ;

using fpoint_1d = generic_point_1d< float > ;
using fpoint_2d = generic_point_2d< float > ;
using fpoint_3d = generic_point_3d< float > ;
using fpoint_4d = generic_point_4d< float > ;
