...
public:
        ...
        constexpr gpu_memory_resource ( context & _ctx_, allocator_config const & _config_ ) ;

        constexpr ~gpu_memory_resource () noexcept { _destroy() ; }
private:
        context          &  ctx_ ;
...
//      constexpr ssize_type _allocated_size  (                    ) const noexcept { return heap_->currentAllocatedSize(                         ) ; }
        ...
        constexpr void _init ( ssize_type _init_size_ ) ;
