...
#include <haze/cpugfx/scene/meta.hxx>
...
public:
        ...
        using colored_rectangle_type = colored_shape< pixel_type, rectangle_type > ;
        using colored_triangle_type  = colored_shape< pixel_type,  triangle_type > ;

        using object_storage =
                uti::variant_vector
                <
                        ::haze::core_memory_resource,
                        filled_rectangle_type,
                        filled_triangle_type,
                        colored_rectangle_type ,
                        colored_triangle_type ,
                        ExtraShapes...,
                        object_data
                > ;
        ...
        constexpr generic_layer (                                     ) noexcept = default ;
        constexpr generic_layer ( shape_type _rect_                   ) noexcept : shape_{ _rect_ }, alpha_{       1.0 } {}
        constexpr generic_layer ( shape_type _rect_, double _opacity_ ) noexcept : shape_{ _rect_ }, alpha_{ _opacity_ } {}
        ...
        UTI_NODISCARD constexpr object_storage       & objects ()       noexcept { return objects_ ; }
        UTI_NODISCARD constexpr object_storage const & objects () const noexcept { return objects_ ; }
private:
        struct object_data
        {
                void const * obj_ ;
